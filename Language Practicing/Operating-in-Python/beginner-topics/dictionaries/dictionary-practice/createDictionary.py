...
# METHOD 1: Here our function will be able to take both list; keys & values
def create_dictionary_manual(keys, values):
    new_dict = {}  # let's create a empty dictionary to get filled
...
# METHOD 2: More efficient method USING .zip() & .dict()
